...
@section('page_title', 'Tambah Riwayat Pekerjaan')
        ...
        <div class="col-md-6">
            <div class="card card-outline">
                <div class="card-header border-0">
                    <h5 class="card-title font-weight-bold m-0"><i class="fas fa-plus mr-2 text-success"></i>Form Tambah Riwayat</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('riwayat.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jabatan_lama" id="jabatan_lama" class="form-control @error('jabatan_lama') is-invalid @enderror" value="{{ old('jabatan_lama') }}" placeholder="Contoh: Guru Honor">
                            @error('jabatan_lama')
                                <div class="invalid-feedback font-weight-bold">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jabatan_baru" id="jabatan_baru" class="form-control @error('jabatan_baru') is-invalid @enderror" value="{{ old('jabatan_baru') }}" placeholder="Contoh: Kepala Tata Usaha" required>
                            @error('jabatan_baru')
                                <div class="invalid-feedback font-weight-bold">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_perubahan" id="tanggal_perubahan" class="form-control @error('tanggal_perubahan') is-invalid @enderror" value="{{ old('tanggal_perubahan', date('Y-m-d')) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="3" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Contoh: Promosi Jabatan Tahunan / Mutasi Internal">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback font-weight-bold">{{ $message }}</div>
                            @enderror
                        </div>
